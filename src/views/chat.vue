...
<template>
    <div class="common-layout w-4/5 mx-auto " style="height:1200px">
        <el-container>
            <el-header height="auto">
                <myheader></myheader>
            </el-header>
            <el-container>
                <el-aside width="333px" class="mr-5" style="overflow: hidden;">
                ...
                <el-main class="border-2 border-inherit border-solid rounded-md ">
                    <div class="flex flex-col h-full w-full">
                        ...
                        <div class="scroll-container mb-[15px] flex-1" ref="scrollRef">
                            <main class="max-h-[600px]  min-h-[500px]">
                                <template v-if="chatStore.chatList.length === 0">
                                    <h1 class="text-center " style="color:white;padding: 20px;font-size: 18px;">请输入以咨询问题</h1>
                                </template>
                                <template v-else>
                        ...
                        <footer class="flex w-full justify-between">
                            ...
                            <el-button class="ml-2 self-end justify-self-end" type="success" plain size="large"
                                @click="handleSubmit">发送</el-button>
                        </footer>
                    </div>
                </el-main>
            </el-container>
